...
//        
    ...
    @IBAction func loginButtonPressed(_ sender: Any) {
        performSegue(withIdentifier: "goToUserOptions", sender: self)    }
    
    /* para retornar
 override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
           if segue.identifier == "goToUserOptions" {
               guard let vc = segue.destination as? UserOptionsViewController else { return }
               vc.textButton = textButton
           }
       }
     */
    /*
